...
for i in range(args.num_scenes):
    ...
    for obj in (sampled_target_bop_objs + sampled_distractor_bop_objs):        
        ...
        # glass material optimal properties
        alpha_value = 1
        ior_value = 1.5
        roughness_value = 0.035
        transmission_value = 1.0
        specular_value = 0.5

        #? apply glass material properties to all objects
        mat.set_principled_shader_value("Base Color", [1, 1, 1, 1]) # white color
        mat.set_principled_shader_value("Alpha", alpha_value)
        mat.set_principled_shader_value("IOR", ior_value)
        mat.set_principled_shader_value("Roughness", roughness_value)
        mat.set_principled_shader_value("Transmission", transmission_value)
        mat.set_principled_shader_value("Specular", specular_value)
